...
class TwitchPlayer extends React.PureComponent {
  ...
  addEventListeners(embed) {
    embed.addEventListener(window.Twitch.Embed.AUTHENTICATE, (user) => {
      if (this.props.onUserLogin) {
        this.props.onUserLogin(user)
      }
    })

    embed.addEventListener(window.Twitch.Embed.VIDEO_PLAY, (data) => {
